...
class UpdateLiteraryGenderRequest extends FormRequest implements IReturnDto
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => [
                ...
                Rule::unique('literary_genders', 'name')->ignore($this->route('literary_gender'), 'id')
            ]
        ];
    }
    ...
    {
        return new LiteraryGenderDTO(id: $this->id, name: trim($this->name));
    }
}
